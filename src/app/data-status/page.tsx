...
async function providerRows() {
  ...
  return [
    ...
    { provider: 'Marketaux', data: '미장/글로벌 뉴스 제목/링크', jobName: 'marketaux-news', ...envStatus(['MARKETAUX_API_TOKEN']) },
    { provider: 'SEC EDGAR', data: '미장 공시', jobName: 'us-sec', ...envStatus(['SEC_USER_AGENT']) },
    { provider: 'US 직접 가격 API', data: 'Alpaca/FMP/Alpha Vantage/Twelve Data', jobName: 'us-direct-quotes', ...envStatus(['US_DIRECT_PRICE_PROVIDER']) },
