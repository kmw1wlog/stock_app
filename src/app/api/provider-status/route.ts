...
const providerDefinitions = [
  ...
  { provider: 'kiwoom-rest', label: 'Kiwoom REST', dataType: 'kr_short_flow', data: 'KR short selling, lending, investor flow', envRequired: ['KIWOOM_REST_API_KEY', 'KIWOOM_REST_API_SECRET'], uiSection: 'Home/Explore flows', jobName: 'kiwoom-kr-flow', mode: 'broker_api' },
