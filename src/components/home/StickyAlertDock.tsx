...
export function StickyAlertDock({ card, formula, candidates, alertSummary, onSimilar, onDetailTop }: StickyAlertDockProps) {
  ...
  return (
    <div
      className="fixed left-1/2 z-40 w-[calc(100vw-32px)] max-w-[398px] -translate-x-1/2 rounded-[28px] border border-slate-200 bg-white/96 p-2 shadow-[0_16px_32px_rgba(15,23,42,0.14)] backdrop-blur"
