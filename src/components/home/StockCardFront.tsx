...
export function StockCardFront({ card, formula, candidates, onShowBack, onSkip }: StockCardFrontProps) {
  ...
  return (
    <section className="flex h-full flex-col overflow-hidden rounded-[30px] bg-[#071426] px-5 pb-5 pt-4 text-white shadow-2xl shadow-slate-900/25">
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="rounded-full border border-white/12 bg-white/8 px-2.5 py-1 text-[10px] font-black text-blue-100/80">{card.dataBasisLabel}</span>
      </div>

      <div className="mt-3.5 flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h2 className="truncate text-[30px] font-black leading-none">{card.name}</h2>
          <p className="mt-1.5 text-sm font-bold text-blue-100">{card.symbol}</p>
        </div>
      ...
      <div className="mt-3 overflow-hidden rounded-3xl bg-white p-1">
      ...
      <div className="mt-3 rounded-3xl bg-white/10 p-4">
        ...
        <p className="mt-2 text-sm font-bold leading-6 text-white">{evidenceSentence}</p>
      </div>
      ...
      <div className="mt-auto pt-4">
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="flex h-14 flex-1 items-center justify-center gap-2 rounded-2xl bg-[#0B63F6] px-4 text-base font-black text-white shadow-lg shadow-blue-500/25"
        ...
        <div className="mt-3 flex items-center justify-center gap-2 text-xs font-black">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-full border border-white/12 bg-white/8 px-3 py-2 text-blue-100"
          >
